...
namespace KisVuzDotNetCore2.Controllers
{
    public class FileDataTypesController : Controller
    {
        ...
        {
            return View(await _context.FileDataTypes.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("FileDataTypeId,FileDataTypeName")] FileDataType fileDataType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FileDataTypeId,FileDataTypeName")] FileDataType fileDataType)
        {

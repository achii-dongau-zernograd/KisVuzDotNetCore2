...
namespace KisVuzDotNetCore2.Controllers
{
    ...
    /// </summary>
    [Authorize(Roles = "Администраторы, Бухгалтерия, Учебная часть, Юротдел, Канцелярия, Приёмная комиссия, ЗамДиректораПоСоцРаботе, ЗамДиректораПоВоспРаботе, Отдел кадров, ЗамДиректораПоМолПолВоспИСоцРаботе, ЗамДиректораПоУРиЦТ, ОВЗ")]
